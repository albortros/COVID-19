...
exp_fit_Par, exp_fit_Cov = curve_fit(exponential_model,x,y,p0=[0.005,0.17,50])
...
plt.errorbar(x, y, yerr=YERR, fmt='o',color="red", alpha=0.75,label="Dati" )
plt.errorbar(Xpredicted,Ypredicted_gompertz, yerr=YPERR_gompertz, fmt='o',color="orange", alpha=0.5,label="Predizioni con Gompertz  ({} giorni)".format(NumberOfDaysPredicted) )
plt.errorbar(Xpredicted,Ypredicted_logistic, yerr=YPERR_logistic, fmt='o',color="green", alpha=0.5,label="Predizioni con logistica ({} giorni)".format(NumberOfDaysPredicted) )
...
plt.semilogy(xTOT, [gompertz(i,gompertz_Par) for i in xTOT], 'b',label="Modello Gompertz" )
plt.semilogy(xTOT, [logistic(i,logistic_Par) for i in xTOT], 'green',label="Modello logistico" )
plt.semilogy(xTOT, [exponential_model(i,exp_fit_Par[0],exp_fit_Par[1],exp_fit_Par[2]) for i in xTOT], 'red', label='Modello esponenziale')
plt.legend()
plt.xlabel("Giorni dal 1 gennaio 2020")
plt.ylabel("Numero delle persone contagiate")
...
plt.errorbar(x, Y3, yerr=ERRY3, fmt='o',color="red", alpha=0.75,label="Dati" )
plt.plot(xTOT, [logistic_derivative(i,logistic_ParD) for i in xTOT], label="Derivata logistica" )
plt.fill_between(xTOT,logistic_YminD,logistic_YmaxD,facecolor='blue', alpha = 0.3 )
plt.plot(xTOT, [gompertz_derivative(i,gompertz_ParD) for i in xTOT], label="Derivata Gompertz" )
plt.fill_between(xTOT,gompertz_YminD,gompertz_YmaxD,facecolor='blue', alpha = 0.3 )
plt.legend()
plt.xlabel("Giorni dal 1 gennaio 2020")
plt.ylabel("Crescita giornaliera delle persone contagiate")
...
plt.legend()
plt.xlabel("Giorni dal 1 gennaio 2020")
plt.ylabel("Crescita giornaliera dei decessi")
...
plt.fill_between(xTOT,Ymin_logistic,Ymax_logistic,facecolor='blue', alpha = 0.3 )
plt.semilogy(xTOT, [gompertz(i,gompertz_Par) for i in xTOT], 'b',label="Modello Gompertz" )
plt.semilogy(xTOT, [logistic(i,logistic_Par) for i in xTOT], 'green',label="Modello logistic" )
plt.legend()
plt.xlabel("Giorni dal 1 gennaio 2020")
plt.ylabel("Numero delle persone guarite")
plt.ylim((min(y)*0.9,gompertz_Par[2]*1.1))
plt.grid(linestyle='--',which='both')
...
plt.legend()
plt.xlabel("Giorni dal 1 gennaio 2020")
plt.ylabel("Crescita giornaliera delle persone guarite")
plt.ylim((min(Y3)*0.9,3*max([logistic_derivative(i,logistic_ParD) for i in xTOT])*1.1))
plt.grid(linestyle='--',which='both')
