...
print('chi2r = ', chi2_gompertz_infected/DOF)
...
YPERR_gompertz=np.array([np.absolute(gompertz(i,ParMAX_gompertz)-gompertz(i,ParMIN_gompertz))/2. for i in Xpredicted])*np.sqrt(chi2_gompertz_infected/DOF)
YPERR_logistic=np.array([np.absolute(logistic(i,ParMAX_logistic)-logistic(i,ParMIN_logistic))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_infected/DOF)
...
chi2_gompertz_deaths = chisquare(y, y_pred_gompertz)[0]
chi2_logistic_deaths = chisquare(y, y_pred_logistic)[0]

print('chi2r =', chi2_gompertz_deaths/DOF)
...
YPERR_gompertz=np.array([np.absolute(gompertz(i,ParMAX_gompertz)-gompertz(i,ParMIN_gompertz))/2. for i in Xpredicted])*np.sqrt(chi2_gompertz_deaths/DOF)
YPERR_logistic=np.array([np.absolute(logistic(i,ParMAX_logistic)-logistic(i,ParMIN_logistic))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_deaths/DOF)
...
chi2_gompertz_recovered = chisquare(y, y_pred_gompertz)[0]
chi2_logistic_recovered = chisquare(y, y_pred_logistic)[0]

print('chi2r =', chi2_gompertz_recovered/DOF)
...
#YPERR_gompertz=[np.absolute(gompertz(i,ParMAX_gompertz)-gompertz(i,ParMIN_gompertz))/2. for i in Xpredicted]
#YPERR_logistic=[np.absolute(logistic(i,ParMAX_logistic)-logistic(i,ParMIN_logistic))/2. for i in Xpredicted]
YPERR_gompertz=np.array([np.absolute(gompertz(i,ParMAX_gompertz)-gompertz(i,ParMIN_gompertz))/2. for i in Xpredicted])*np.sqrt(chi2_gompertz_recovered/DOF)
YPERR_logistic=np.array([np.absolute(logistic(i,ParMAX_logistic)-logistic(i,ParMIN_logistic))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_recovered/DOF)
