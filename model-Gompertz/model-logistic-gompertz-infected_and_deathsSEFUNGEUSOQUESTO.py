...
#
#YPERR_gompertz=np.array([np.absolute(gompertz(i,ParMAX_gompertz)-gompertz(i,ParMIN_gompertz))/2. for i in Xpredicted])
#YPERR_logistic=np.array([np.absolute(logistic(i,ParMAX_logistic)-logistic(i,ParMIN_logistic))/2. for i in Xpredicted])
#
