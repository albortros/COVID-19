...
plt.savefig(namefile+model+case[0]+types[0]+region+ext, dpi=DPI)
...
plt.ylim((min(y)*0.9,Par[2]*1.1))
plt.grid(linestyle='--',which='both')
plt.savefig(namefile+model+case[0]+types[1]+region+ext, dpi=DPI)
...
plt.grid(linestyle='--',which='both')
plt.savefig(namefile+model+case[0]+types[3]+region+ext, dpi=DPI)
...
plt.ylim((min(Y3)*0.9,max([logistic_derivative(i,fit_derivative[0]) for i in list(X)+pred_x])*1.3))
plt.grid(linestyle='--',which='both')
plt.savefig(namefile+model+case[1]+types[3]+region+ext, dpi=DPI)
...
plt.ylim((min(y)*0.9,Par[2]*1.1))
plt.grid(linestyle='--',which='both')
plt.savefig(namefile+model+case[2]+types[0]+region+ext, dpi=DPI)
...
plt.ylim((min(y)*0.9,Par[2]*1.1))
plt.grid(linestyle='--',which='both')
plt.savefig(namefile+model+case[2]+types[1]+region+ext, dpi=DPI)
