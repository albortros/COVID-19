...
YPERR=np.array([np.absolute(logistic(i,ParMAX)-logistic(i,ParMIN))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_infected)
...
Ymin=[logistic(i,ParMAX) for i in xTOT]
Ymax=[logistic(i,ParMIN) for i in xTOT]
YPERR=np.array([np.absolute(logistic(i,ParMAX)-logistic(i,ParMIN))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_deaths)
...
Ymin=[logistic(i,ParMAX) for i in xTOT]
Ymax=[logistic(i,ParMIN) for i in xTOT]
YPERR=np.array([np.absolute(logistic(i,ParMAX)-logistic(i,ParMIN))/2. for i in Xpredicted])*np.sqrt(chi2_logistic_recovered)
